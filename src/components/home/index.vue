        ...
        >
          <el-submenu index="shipInformation" @click.native="goTo('/shipInformation')">
            ...
            <el-submenu index="2-1">
              ...
              <el-menu-item index="2-1-1">渔船类型统计</el-menu-item>
          ...
          <el-submenu index="5">
            ...
            <el-submenu index="5-1">
              ...
              <el-checkbox-group v-model="checkList" @change="handleCheckedCitiesChange">
                <el-checkbox label="休闲渔船作业区"></el-checkbox>
                <el-checkbox label="资源保护区"></el-checkbox>
                <el-checkbox label="养殖区"></el-checkbox>
                <el-checkbox label="海钓区"></el-checkbox>
              </el-checkbox-group>
              <!-- <el-menu-item @click="showRelaxZone">休闲渔船作业区</el-menu-item>
              <el-menu-item @click="showPropectionZone">资源保护区</el-menu-item>
              <el-menu-item @click="showBreedZone">养殖区</el-menu-item>
              <el-menu-item @click="showFishingZone">海钓区</el-menu-item>-->
            </el-submenu>
          ...
          <el-submenu index="11">
            ...
            <el-menu-item index="7-1">渔船动态展示</el-menu-item>
            <el-menu-item index="7-2">气象信息展示</el-menu-item>
            <el-menu-item index="7-3">休闲作业区域展示</el-menu-item>
            <el-menu-item index="7-3">海钓场展示</el-menu-item>
            <el-menu-item index="7-3">海洋水文展示</el-menu-item>
            <el-submenu index="7-4">
              <template slot="title">监管举报</template>
              <el-menu-item index="7-4-1">伏休期举报</el-menu-item>
              <el-menu-item index="7-4-2">非法捕捞举报</el-menu-item>
              <el-menu-item index="7-4-3">涉渔三无船只举报</el-menu-item>
            </el-submenu>
          </el-submenu>
        </el-menu>
        <div class="line"></div>
...
export default {
  ...
  methods: {
    ...
    handleCheckedCitiesChange() {
      this.relaxZone = containZone( this.checkList,this.relaxZone,"休闲渔船作业区");
      this.alarmZone = containZone(this.checkList,this.alarmZone,"资源保护区");
      this.breedZone = containZone(this.checkList,this.breedZone,"养殖区");
      this.fishingZone = containZone(this.checkList,this.fishingZone,"海钓区");
    },
    getMapObject(val){
      this.map = val
    }
